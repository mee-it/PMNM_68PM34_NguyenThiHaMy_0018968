            ...
            <form action="/sinhvien/update/<?php echo $sinhvien['id']; ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select id="gioitinh" name="gioitinh" class="form-select" required>
                        ...
                        <option value="Nam" <?php echo $sinhvien['gioitinh'] == 'Nam' ? 'selected' : ''; ?>>
                            Nam
                        </option>

                        <option value="Nữ" <?php echo $sinhvien['gioitinh'] == 'Nữ' ? 'selected' : ''; ?>>
                            Nữ
                        </option>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="mssv" name="mssv" class="form-control"
                        value="<?php echo htmlspecialchars($sinhvien['mssv']); ?>" readonly>
                </div>
